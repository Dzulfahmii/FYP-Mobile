...
<template>
    ...
    <k-list class="shadow border  border-zinc-200" strong  inset>
      <div class="my-5 mx-5">
        <k-button @click="()=>router.push({name:'EditAsset', params:{id:asset.id}})" class="border-gray-300 bg-white" outline>Edit</k-button>
